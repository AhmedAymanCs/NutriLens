...
class HomePage extends StatelessWidget {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(userModel.name ?? "No Name", style: AppTextStyle.font32PrimaryBold),
            Text(userModel.weight ?? "0", style: AppTextStyle.font32PrimaryBold),
  ...
  style: AppTextStyle.font32PrimaryBold,
            ...
            Text(userModel.gender ?? "Not Specified", style: AppTextStyle.font32PrimaryBold),
            Text(userModel.goal ?? "No Goal Set", style: AppTextStyle.font32PrimaryBold),
          ],
        ),
      ),
    );
